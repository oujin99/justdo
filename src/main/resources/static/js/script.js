const searchPc1 = document.querySelector('.h_search input');
const searchPcBorder1 = document.querySelector('.h_search');
const searchPcWrap1 = document.querySelector('.h_search .search_tab_wrap');
...
closeBtnPc.addEventListener("click", function (){
  ...
  searchPcBorder1.classList.remove('active');
});
